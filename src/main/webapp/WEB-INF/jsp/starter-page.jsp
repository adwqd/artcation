  ...
  <main class="main">
    ...
    <div class="page-title dark-background">
      <div class="container position-relative">
        <h1><c:out value="${pageTitle}" default="Starter Page"/></h1>
        <p><c:out value="${pageDescription}" default="Esse dolorum voluptatum ullam est sint nemo et est ipsa porro placeat quibusdam quia assumenda numquam molestias."/></p>
        <nav class="breadcrumbs">
          <ol>
            <li><a href="<c:url value='/'/>">Home</a></li>
            <li class="current"><c:out value="${breadcrumbTitle}" default="Starter Page"/></li>
          </ol>
        </nav>
      </div>
    </div><!-- End Page Title -->
